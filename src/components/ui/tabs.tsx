...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-lg bg-background-secondary p-1 text-foreground-secondary shadow-sm border border-border",
      className
    )}
    {...props}
  />
